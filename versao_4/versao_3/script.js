...
"CASO", "CARO", "COLA", "LAGO", "MALA", "MACA", "ANTA", "SACO", "GATO", "TOPO", "ROLO", "LOGO", "PISO", "BOLO"];
let palavra = "AAAA";
...
function vitoria() {
    txt_vitoria.innerHTML = "VOCÊ ACERTOU A PALAVRA: " + palavra + "<br>SEU TEMPO FOI: " + i_timer;
...
function derrota() {
    txt_derrota.innerHTML = "VOCÊ ERROU... A PALAVRA ERA: " + palavra + "<br>SEU TEMPO FOI: " + i_timer;
...
function jogo() {
    ...
    timer.innerHTML = "TIMER: " + i_timer
    const timer_fun = setInterval(() => {
        i_timer += 1
        timer.innerHTML = "TIMER: " + i_timer

        if (timer_track == false) {
